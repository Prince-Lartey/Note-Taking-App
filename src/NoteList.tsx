...
const NoteList = ({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) => {
    ...
    return (
        <>
            ...
            <EditTagsModal onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} show={editTagModalIsOpen} handleClose={() => setEditTagModalIsOpen(false)} availableTags={availableTags} />
        </>
    )
}
